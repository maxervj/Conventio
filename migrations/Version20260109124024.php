 ...
 */
final class Version20260109124024 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE professor_formation (professor_id INT NOT NULL, formation_id INT NOT NULL, INDEX IDX_439A9A097D2D84D5 (professor_id), INDEX IDX_439A9A095200282E (formation_id), PRIMARY KEY(professor_id, formation_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
